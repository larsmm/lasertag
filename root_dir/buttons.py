...
def __init():
	...
	_buttons.register( _gpioMap[BTN_PEW],  __cb_btn_pew  )
...
def pushMapping(newMapping=None):
	global __cb
	if newMapping == None:
		newMapping = { BTN_A: None, BTN_B: None, BTN_C: None, BTN_BOOT: __cbReboot, BTN_PEW: None }
